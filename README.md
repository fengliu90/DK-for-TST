...
Hi, this is the pytorch code for MMD with deep kernel, presented in the paper "Learning Deep Kernels for Non-Parametric Two-Sample Tests" (https://arxiv.org/abs/2002.09116).
