...
for n in n_list:
    ...
    for kk in range(K):
        ...
        h_u1, threshold_u1, mmd_value_u1 = TST_MMD_u(model_u1(S), N_per, N1, S, sigma, sigma0_u, alpha, device, dtype, ep)
        ...
        for k in range(N):
            ...
            h_u1, threshold_u1, mmd_value_u1 = TST_MMD_u(model_u1(S), N_per, N1, S, sigma, sigma0_u, alpha, device,dtype, ep)  # G+J
            h_adaptive, threshold_adaptive, mmd_value_adaptive = TST_MMD_adaptive_bandwidth(S_m, N_per, N1, S_m, sigma,
                                                                                            sigma0, alpha, device,
                                                                                            dtype)  # G+C
    ...
    count = count + 1
    f = open('Results_'+str(n)+'_H0_abl.pckl_C2ST', 'wb')
